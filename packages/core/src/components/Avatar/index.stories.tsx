...
export const AllVariants: Story = {
  render: () => (
    <NuGroup>
      <NuAvatar neuVariant="raised" radius="xl" size="lg">R</NuAvatar>
      <NuAvatar neuVariant="inset" radius="xl" size="lg">I</NuAvatar>
      <NuAvatar neuVariant="flat" radius="xl" size="lg">F</NuAvatar>
    </NuGroup>
  ),
};
