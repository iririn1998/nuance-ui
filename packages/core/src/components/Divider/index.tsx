 ...
 */
export const NuDivider = forwardRef<HTMLDivElement, NuDividerProps>(({ className: propsClassName, ...props }, ref) => {
  return <MantineDivider ref={ref} className={clsx(className.root, propsClassName)} {...props} />;
});
