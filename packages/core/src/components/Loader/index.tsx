 ...
 */
export const NuLoader = forwardRef<HTMLSpanElement, NuLoaderProps>(({ className: propsClassName, ...props }, ref) => {
  return <MantineLoader ref={ref} className={clsx(className.root, propsClassName)} {...props} />;
});
